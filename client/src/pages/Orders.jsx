              ...
              <div key={order._id} className="border p-4 rounded shadow-sm bg-white">
                ...
                >
                  <div>
                    ...
                    {(order.status === 'assigned' || order.status === 'picked_up' || order.status === 'out_for_delivery') && (
                      <Link
                        to={`/delivery-tracker/${order._id}`}
                        className="inline-block mt-2 bg-orange-500 text-white px-3 py-1 rounded text-sm hover:bg-orange-600 transition"
                      >
                        Track Delivery
                      </Link>
                    )}
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-gray-500 mt-2">{items.length || 0} item{items.length === 1 ? '' : 's'}</p>
